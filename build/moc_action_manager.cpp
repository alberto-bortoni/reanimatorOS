/****************************************************************************
** Meta object code from reading C++ file 'action_manager.h'
**
...
#include "../src/action_manager.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'action_manager.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 31, 23) // "symbolShortcutActivated"

    },
    "ActionManager\0insertText\0\0text\0"
    "symbolShortcutActivated"
};
...
void ActionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->symbolShortcutActivated(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ActionManager::insertText)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActionManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ActionManager.data,
      qt_meta_data_ActionManager,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void ActionManager::insertText(const QString & _t1)
{
